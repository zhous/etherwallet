// simplified Chinese, zh-CN, 简体中文，反馈请发邮件至：zhous1998@gmail.com，或通过QQ（或微信）：5449191
'use strict';
var zhcn = function() {}
zhcn.code = 'zhcn';
zhcn.data = {
...
NAV_Help                    : '帮助 ',
NAV_InteractContract        : '通过合约互动 ',
NAV_Multisig                : '多重签名 ',
NAV_MyWallets               : '我的钱包 ',
NAV_Offline                 : '离线转账 ',
NAV_SendEther               : '以太币及代币转账 ', //
NAV_SignMsg                 : '消息签名 ',
NAV_Swap                    : '兑换 ',
...
/* General */
x_Access                    : '使用 ',
x_AddessDesc                : '你可以把地址理解为你的“账户”。你将地址告诉别人，他们就可以向你发送以太币。地址边上那个简陋的图标有助于识别你。 ',
x_Address                   : '你的地址 ',
x_Cancel                    : '取消 ',
x_CSV                       : 'CSV文件（未加密） ',
x_Download                  : '下载 ',
x_Json                      : 'JSON文件（未加密） ',
x_JsonDesc                  : '这是你的未加密的JSON格式的私钥文件。 使用它你发送交易时就不需要密码，也意味着拿到这个文件的人可以无需密码就能控制你的钱包和里面的所有数字货币。 ',
x_Keystore                  : 'Keystore文件（UTC / JSON · 推荐 · 加密的） ',
x_Keystore2                 : 'Keystore文件（UTC / JSON ） ',
x_KeystoreDesc              : '这个Keystore文件和Mist钱包使用的文件是一样的，所以将来你可以非常容易地导入Mist钱包。 推荐下载和备份这个文件。 ',
x_Mnemonic                  : '助记词 ',
x_ParityPhrase              : 'Parity Phrase ',
x_Password                  : '密码 ',
x_Print                     : '打印纸钱包 ',
x_PrintDesc                 : '小技巧：假使你没有打印机。点击打印后，你可以保存为PDF格式文件。 ',
x_PrintShort                : '打印 ',
x_PrivKey                   : '私钥（未加密） ',
x_PrivKey2                  : '私钥 ',
x_PrivKeyDesc               : '这是未加密的私钥，使用它不需要密码即可进入你的钱包。 如果他人拿到了这个私钥，无需密码就能够控制你的钱包。 出于安全考虑，我们推荐你使用加密的私钥文件。 ',
x_Save                      : '保存 ',
x_TXT                       : '普通文本文件（未加密） ',
x_Wallet                    : '钱包 ',
...
CX_Warning_1                : '确保你备份了保存在这里的所有钱包。 许多事情包括卸载和重装扩展，都会让你丢失Chrome扩展中的数据。这个扩展是一种使用钱包的简单方式，但不是备份钱包的方式。 ',
MEW_Tagline                 : '开源JavaScript客户端以太币钱包 ',
CX_Tagline                  : '开源JavaScript客户端以太币钱包Chrome扩展 ',

/* Footer */
FOOTER_1                    : '一个开源的生成以太坊钱包和发送交易的客户端工具 ',
FOOTER_1b                   : '创建者 ',
FOOTER_2                    : '欢迎捐赠我们： ',
FOOTER_3                    : '客户端钱包创建者 ',
FOOTER_4                    : '声明 ',
...
sidebar_donation            : 'MyEtherWallet是安全且能保护你的隐私的免费、开源的钱包软件。 我们收到的捐赠越多，我们开发新特性、听取你的反馈的时间就越多，本软件也就更能符合你的需求。我们只是两个尝试改变世界的开发者。您乐意帮助我们吗？ ',
sidebar_donate              : '捐赠 ',
sidebar_thanks              : '谢谢你！！！ ',

/* Decrypt Panel */
decrypt_Access              : '你将怎样使用钱包？ ',
decrypt_Title               : '选择你的私钥格式： ',
...
ADD_Radio_3                 : '粘贴或输入你的私钥 ',
ADD_Radio_4                 : '添加要查阅的账户 ',
ADD_Radio_5                 : '粘贴或输入你的助记词 ',
ADD_Radio_5_Path            : '选择多层确认钱包的衍生路径 ',
ADD_Radio_5_PathCustom      : '自定义',
ADD_Label_2                 : '创建钱包昵称： ',
ADD_Label_3                 : '你的钱包已加密，请输入密码： ',
ADD_Label_4                 : '添加要查阅的账户 ',
ADD_Warning_1               : '无需上传私钥，你即可在钱包标签里添加任何要查阅的账户。但这不意味着你可以使用该钱包或者发送里面的数字货币。 ',
ADD_Label_5                 : '输入地址： ',
ADD_Label_6                 : '解锁钱包 ',
